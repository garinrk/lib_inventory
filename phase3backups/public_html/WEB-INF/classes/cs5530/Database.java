...
public static String BrowseLibraryWeb(int numberOfTitleWords, int numberOfAuthors, ArrayList<String> params, boolean allBooks, String sortBy, Connection con)
{
...
// int numberOfAuthors = authors.length;
    ...
    String sql = "SELECT * FROM " + RecordsTable +" r, " + AuthorListTable + " a, " + InventoryTable + " i WHERE r.isbn = a.isbn AND";


//add title words
    for(int i = 0; i <numberOfTitleWords; i++)
        sql = sql.concat("\n title LIKE ? AND\n");
